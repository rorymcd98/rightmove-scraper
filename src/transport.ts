...
export const stations = {
    ...
    "Blackfriars": ["District", "Circle", "Thames"],
    ...
    "Elephant & Castle": ["Thames", "Northern", "Bakerloo"],
    "Elm Park": ["District"],
    ...
    "Fairlop": ["Central"],
    "Farringdon": ["Thames", "Metropolitan", "Circle", "Hammersmith City", "Elizabeth"],
    "Finchley Central": ["Northern"],
    "Finchley Road": ["Metropolitan", "Jubilee"],
    "Finsbury Park": ["Piccadilly", "Victoria", "Thames"],
    ...
    "Kentish Town": ["Northern", "Thames"],
    "Kenton": ["Bakerloo"],
    "Kew Gardens": ["District"],
    "Kilburn": ["Jubilee"],
    "Kilburn Park": ["Bakerloo"],
    "Kingsbury": ["Jubilee"],
    "King's Cross St Pancras": ["Thames", "Metropolitan", "Northern", "Piccadilly", "Circle", "Victoria", "Hammersmith City"],
    ...
    "London Bridge": ["Northern", "Jubilee", "Thames"],
    "Loughton": ["Central"],
    "Maida Vale": ["Bakerloo"],
